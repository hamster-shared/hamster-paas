...
func SendEmailForNodeCreate(node node.RPCNode) {
	from := os.Getenv("FROM_EMAIL")
	password := os.Getenv("EMAIL_PASSWORD")
	to := []string{"bingjian.wang@tntlinking.com", "haijiang.mo@tntlinking.com", "jianguo.sun@tntlinking.com"}
	subject := "Node Create"

	body := "<!DOCTYPE html>\n<html>\n<head>\n    <meta charset=\"UTF-8\">\n    <title>Test Results</title>\n    <style>\n\n        .content {\n            background-color: white;\n            padding: 20px;\n        }\n\n        .content .head {\n            font-family: BinancePlex, Arial, PingFangSC-Regular, 'Microsoft YaHei', sans-serif;\n            font-size: 20px;\n            font-weight: 900;\n            line-height: 25px;\n            text-align: left;\n            color: #000000;\n        }\n\n        .content .label {\n            font-size: 12px;\n            font-weight: 800;\n            line-height: 20px;\n            color: #000000;\n        }\n\n        .footer {\n            position: absolute;\n            bottom: 0;\n            right: 0;\n            padding: 10px;\n            font-size: 12px;\n            color: #000000;\n            text-align: right;\n        }\n\n        .footer a {\n            color: #000000;\n            text-decoration: none;\n        }\n\n        .wrapper {\n            position: relative;\n            min-height: 100%;\n        }\n\n        .content-wrapper {\n            padding-bottom: 60px;\n        }\n    </style>\n</head>\n<body>\n    <div class=\"wrapper\">\n<div class=\"content-wrapper\">\n            <div class=\"content\">\n <p>The following RPCNode needs to be created:</p>\n                <table>\n                    <tr>\n                        <td class=\"label\">Node Name:</td>\n                        <td>" + node.Name + "</td>\n                    </tr>\n                    <tr>\n                        <td class=\"label\">Node ID:</td>\n                        <td>" + strconv.Itoa(int(node.Id)) + "</td>\n                    </tr>\n                    <tr>\n                        <td class=\"label\">NodeChainProtocol:</td>\n                        <td>" + string(node.ChainProtocol) + "</td>\n                    </tr>\n                    <tr>\n                        <td class=\"label\">TNodeRegion:</td>\n                        <td>" + node.Region + "</td>\n                    </tr>\n                    <tr>\n                        <td class=\"label\">NodeResource:</td>\n                        <td>" + node.Resource + "</td>\n                    </tr>\n                    <tr>\n                        <td class=\"label\">NodeLaunchTime:</td>\n                        <td>" + node.LaunchTime.Time.Format("2006-01-02 15:04:05") + "</td>\n                    </tr>\n                </table>\n            </div>\n        </div>\n        <div class=\"footer\">\n            <p>Hamster team</p>\n            <p><a href=\"http://www.hamsternet.io\">www.hamsternet.io</a></p>\n        </div>\n    </div>\n</body>\n</html>\n"
	msg := "From: " + from + "\n" +
		"To: " + strings.Join(to, ";") + "\n" +
		"Subject: " + subject + "\n" +
